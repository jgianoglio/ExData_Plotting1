...
# Top Right
with(epcData, plot(epcData$dateTime, epcData$Volt, type="l", xlab="datetime", 
                   ylab="Voltage", ylim=c(234, 246)))

# Bottom Right
with(epcData, plot(epcData$dateTime, epcData$Global_reactive_power, type="l", xlab="datetime", 
